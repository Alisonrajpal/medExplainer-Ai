...
const MedicalExplainer: React.FC<MedicalExplainerProps> = ({ compact = false }) => {
  ...
  const exampleQueries = [
    { text: "What is hypertension?", icon: "🫀" },
    { text: "Explain myocardial infarction", icon: "❤️" },
    { text: "What does high cholesterol mean?", icon: "🩸" },
    { text: "How does metformin work?", icon: "💊" },
    { text: "What is Type 2 Diabetes?", icon: "🩺" },
    { text: "Explain insulin resistance", icon: "🔬" },
  ];
